		...
		<div class="wrapper d-flex align-items-stretch">
			<nav id="sidebar">
              ...
              <li>
                ...
                <li>
                    <a href="page/data_petugas.php">  Data Petugas</a>
                </li>
                <li>
                    <a href="page/data_masyarakat.php">  Data Masyarakat</a>
                </li>
                <li>
                    <a href="page/data_laporan.php">  Data Laporan</a>
                </li>
                <li>
                    <a href="page/data_tanggapan.php">  Data Tanggapan</a>
                </li>
	            </ul>
            </li>
            <li>
  ...
  <div class="card">
    <div class="additional">
      ...
      <div class="more-info">
        <h1></h1>
        <div class="coords">
          <span><?php echo $_SESSION['akun_nama']; ?> Ada <?php echo $cek; ?> Pengaduan Dari Masyarakat
        Yang Belum Anda Tanggapi</span>
        </div>
        <div class="stats">         
        </div>
      </div>
    ...
    <div class="general">
      ...
      <p>di Dasboard Admin Aplikasi Pelaporan Pengaduan Masyarakat Desa Tajur 
      </p>
