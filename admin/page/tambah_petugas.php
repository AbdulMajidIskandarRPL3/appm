...
// Set path folder tempat menyimpan fotonya
    $simpan=mysqli_query($koneksi,"INSERT INTO petugas(nama_petugas, username, password, telepon, level) 
    VALUES('$nama', '$username', '$password', '$telepon', '$level')");
if($simpan){
    echo '<script language="javascript">
          alert ("Tambah Data Petugas Berhasil Di Lakukan!");
          window.location="data_petugas.php";
          </script>';
          exit();
}else{
    echo '<script language="javascript">
          alert ("Tambah Data gagal Di Lakukan! Silahkan Untuk Mengulangi kembali");
          window.location="data_petugas.php";
          </script>';
          exit(); 
}
...
?>
    ...
    <form class="contact1-form validate-form" method="POST" action="tambah_petugas.php?proses=simpan" enctype="multipart/form-data">
        <span class="contact1-form-title">
            Form Tambah Petugas
        </span>

        <div class="wrap-input1 validate-input" data-validate = "Name is required">
            <input class="input1" type="text" name="nama_petugas" placeholder="Nama Petugas">
        ...
        <div class="wrap-input1 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
            <input class="input1" type="text" name="telepon" placeholder="Telepon">
            <span class="shadow-input1"></span>
        </div>
