        ...
        <div class="table-wrapper">
            ...
            <div class="table-title">
                <div class="row">
                    ...
                    <div class="col-xs-7">
                        <a href="generate_tanggapan.php" class="btn btn-primary"><i class="fa fa-print" aria-hidden="true"></i> <span>Generate Laporan</span></a>						
                    </div>
                </div>
            </div>
            <table class="table table-striped table-hover">
                ...
                <tbody>
                <?php
                $produktebaru=mysqli_query($koneksi,"SELECT * FROM tanggapan LIMIT 0,6");
            ...
            ?>
                    ...
                    <td><?php echo $tampilproduk['id_tanggapan']; ?></td>
                        ...
                        <td><?php echo substr($tampilproduk['tanggapan'], 0, 25)  ?>  ...</td>
                        <td><?php echo $tampilproduk['tgl_tanggapan']; ?></td> 
                        <td>
                            <a href="edit_tanggapan.php?id=<?php echo $tampilproduk['id_tanggapan']; ?>" class="settings" title="Edit" data-toggle="tooltip"><i class="fa fa-edit" aria-hidden="true"></i></a>
                            <a href="hapus_tanggapan.php?id=<?php echo $tampilproduk['id_tanggapan']; ?>" class="delete" title="Hapus" data-toggle="tooltip" onclick="return confirm('Yakin Ingin Menghapus Data Ini?')"><i class="fa fa-trash" aria-hidden="true"></i></a>
                        </td>
                    </tr>
