    ...
    <div class="table-responsive">
        <div class="table-wrapper">
            ...
            <table class="table table-striped table-hover">
                ...
                <tbody>
                <?php
                $produktebaru=mysqli_query($koneksi,"SELECT * FROM USER LIMIT 0,6");
                while($tampilproduk=mysqli_fetch_array($produktebaru)){
            ?>
                    <tr>
                        <td><?php echo $tampilproduk['id_user']; ?></td>
                        ...
                        <td><?php echo $tampilproduk['telp']; ?></td>
                        <td>
                            <a href="detail_masyarakat.php?id=<?php echo $tampilproduk['id_user']; ?>" class="settings" title="Lihat" data-toggle="tooltip"><i class="fa fa-eye" aria-hidden="true"></i></a>
                            <a href="hapus_masyarakat.php?id=<?php echo $tampilproduk['id_user']; ?>" class="delete" title="Hapus" data-toggle="tooltip" onclick="return confirm('Yakin Ingin Menghapus Data Ini?')"><i class="fa fa-trash" aria-hidden="true"></i></a>
                        </td>
                    </tr>
