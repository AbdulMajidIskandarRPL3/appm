...
// Set path folder tempat menyimpan fotonya
    $simpan=mysqli_query($koneksi,"UPDATE petugas SET nama_petugas='$nama', username='$username', password='$password',
    telepon='$telepon', level='$level', id_petugas='$id' WHERE id_petugas='$id'");
if($simpan){
...
?>
    ...
    <form class="contact1-form validate-form" method="POST" action="edit.php?proses=simpan" enctype="multipart/form-data">
        ...
        <div class="wrap-input1 validate-input" data-validate = "Name is required">
            <input class="input1" type="text" name="nama_petugas" value="<?php echo $data['nama_petugas'] ?>">
            <span class="shadow-input1"></span>
        </div>

        <div class="wrap-input1 validate-input" >
            <input class="input1" type="text" name="username" value="<?php echo $data['username'] ?>">
            <span class="shadow-input1"></span>
        </div>

        <div class="wrap-input1 validate-input" >
            <input class="input1" type="text" name="password" value="<?php echo $data['password'] ?>">
            <span class="shadow-input1"></span>
        </div>

        <div class="wrap-input1 validate-input" >
            <input class="input1" type="text" name="telepon" value="<?php echo $data['telepon'] ?>">
            <span class="shadow-input1"></span>
        </div>

        <div class="wrap-input1 validate-input">
            <select class="input1" type="text" name="level">
