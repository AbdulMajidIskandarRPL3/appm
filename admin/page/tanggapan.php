        ...
        <div class="table-wrapper">
            ...
            <div class="table-title">
                <div class="row">
                    ...
                    <div class="col-xs-7">
                        <a href="excel.php" class="btn btn-primary"><i class="material-icons">&#xE24D;</i> <span>Export to Excel</span></a>						
                    </div>
                </div>
            </div>
            <table class="table table-striped table-hover">
                ...
                <tbody>
                <?php
                $produktebaru=mysqli_query($koneksi,"SELECT * FROM pengaduan WHERE status='proses'  LIMIT 0,6");
                $no = 1;
            ...
            ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="detail_pengaduan.php?id=<?php echo $tampilproduk['id_pengaduan']; ?>" class="delete" title="Buat Tanggapan" data-toggle="tooltip"><i class="fa fa-comments" aria-hidden="true"></i></a>
                        </td>
                    </tr>
