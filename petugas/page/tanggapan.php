  ...
  <body>
		...
		<div class="wrapper d-flex align-items-stretch">
			<nav id="sidebar">
	          ...
	          <li>
	              <a href="tanggapan.php"><span class="fa fa-pencil mr-3"></span> Verifikasi Pengaduan</a>
			  </li>
			  <li>
    ...
    <div class="table-responsive">
        <div class="table-wrapper">
            ...
            <table class="table table-striped table-hover">
                ...
                <tbody>
                <?php
                $produktebaru=mysqli_query($koneksi,"SELECT * FROM pengaduan WHERE status='0' ");
                $no = 1;
